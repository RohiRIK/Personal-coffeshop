  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-stone-800 rounded-2xl border border-stone-700">
      ...
      <button
        ...
        disabled={loading}
        className="w-full py-3 px-4 rounded-xl font-medium text-stone-100 bg-stone-700 hover:bg-stone-600 border border-stone-600 transition-colors flex items-center justify-center gap-3 mb-6 disabled:opacity-50"
      >
