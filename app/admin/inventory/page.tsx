  ...
  return (
    <div>
      ...
      <p className="text-stone-400 mb-8">
        Manage real-time availability of ingredients. Changes update instantly
        on the menu.
      </p>
...
function InventoryItemRow({
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-stone-800 rounded-xl border border-stone-700">
      ...
      <button
        onClick={onToggle}
        className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-stone-900 ${
