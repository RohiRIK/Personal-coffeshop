...
export function CustomizationForm({ menuItemId, imageUrl, price, itemName }: CustomizationFormProps) {
    ...
    return (
        <div className="space-y-6">
            {/* Milk Selection */}
            <div>
                <h3 className="text-lg font-bold text-stone-100 mb-3">Choose Your Milk</h3>
            ...
            {/* Cup Selection */}
            <div>
                <h3 className="text-lg font-bold text-stone-100 mb-3">Choose Your Cup</h3>
                <div className="grid grid-cols-2 gap-3">
                    {CUP_OPTIONS.map((cup) => {
                        ...
                        return (
                            ...
                            >
                                <span className={`block font-bold ${selectedCup === cup.id ? 'text-amber-400' : 'text-stone-100'}`}>
                                    {cup.name}
                                </span>
                                <span className="text-sm text-stone-400">{cup.description}</span>
                                {!available && (
            ...
            <div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <span className="text-2xl font-bold text-stone-100 w-12 text-center">{quantity}</span>
                    <button
            ...
            <div>
                <h3 className="text-lg font-bold text-stone-100 mb-3">Special Instructions</h3>
                <textarea
                    value={instructions}
            ...
            <div className="bg-stone-800 p-4 rounded-xl border border-stone-700">
                ...
                <div className="mt-4 pt-4 border-t border-stone-700 flex justify-between items-center">
                    ...
                    <span className="text-xl font-bold text-amber-400">${(price * quantity).toFixed(2)}</span>
                </div>
            </div>
