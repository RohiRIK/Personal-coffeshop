            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {items.length === 0 ? (
                        ...
                        items.map((item) => (
                            <div key={item.id} className="bg-stone-800 rounded-xl p-3 flex gap-4 border border-stone-700">
                                {/* Image (Small) */}
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-start mb-1">
                                        <h3 className="font-bold text-stone-100 truncate pr-2">{item.name}</h3>
                                        <button
                                    ...
                                    <div className="text-xs text-stone-400 space-y-0.5 mb-3">
                                        ...
                                        {item.options.instructions && <p className="italic truncated">"{item.options.instructions}"</p>}
                                    </div>
