            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="relative aspect-square rounded-2xl overflow-hidden">
                        ...
                        {/* Tag badge */}
                        <div className={`absolute top-4 left-4 flex items-center gap-1 px-3 py-1.5 rounded-full text-sm font-bold ${item.tag === 'Hot' ? 'bg-orange-500' : 'bg-blue-500'
                            }`}>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <h1 className="text-3xl md:text-4xl font-bold text-stone-100">{item.name}</h1>
                            <p className="text-2xl font-bold text-amber-400 mt-2">${item.price.toFixed(2)}</p>
                        </div>
